<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Masters/User.master" AutoEventWireup="true" CodeFile="MinhasCaravanas.aspx.cs" Inherits="Pages_ToUser_MinhasCaravanas" %>
            ...
            <div class="tabs">
                ...
                <div class="tab-select-outer">
                    <select id="tab-select">
                        <option value="#tab01">Caravanas criadas</option>
                        <option value="#tab02">Inscrições feitas</option>
                    </select>
                </div>
